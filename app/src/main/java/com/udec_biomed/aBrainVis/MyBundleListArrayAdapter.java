...
public class MyBundleListArrayAdapter extends ArrayAdapter<String> {
    private final Context context;
    private final ArrayList<String> values;
    public CheckBox cb;
    public boolean DisplayBundles[];

    public MyBundleListArrayAdapter(Context context, List<String> values, boolean[] displayBundle) {
